...
export const CEFR_LEVEL_COPY: Record<CEFRLevel, string> = {
  [CEFRLevel.A1]: $localize`I know some words and set phrases.`,
  [CEFRLevel.A2]: $localize`I can follow short, direct sentences about familiar things.`,
  [CEFRLevel.B1]: $localize`I can get through a simple story if I look words up often.`,
  [CEFRLevel.B2]: $localize`I can follow a novel with a dictionary nearby.`,
  [CEFRLevel.C1]: $localize`I read fluently and stop only at unusual or literary words.`,
  [CEFRLevel.C2]: $localize`I read anything, including older and specialised prose.`,
};
