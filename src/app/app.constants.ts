...
export class AppConstants {
  ...
  public static DECKS_URL = AppConstants.API_URL + '/decks';
  public static SHARES_URL = AppConstants.API_URL + '/shares';
  public static PUBLIC_SHARES_URL = AppConstants.PUBLIC_URL + '/shares';
