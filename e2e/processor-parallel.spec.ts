...
test('selects an English companion edition and highlights a many-to-one sentence group', async ({page}) => {
  ...
  const primaryPane = page.locator('.sbs-column-main').last();
  const companionPane = page.locator('.sbs-column-secondary').last();
